bot=
    .about=
        💬 Bot for communicating with @artsayo
    .description=
        💬 I will help you get in touch with @artsayo
    .start=
        💫 Start the bot
    .help=
        💬 Help
help=
    .dm=
        👋 Hello, <b>{ $name }</b>! I am a bot for communicating with <a href="https://t.me/artsayo">Sayolight</a>.

        💬 Please describe your problem, question, or suggestion in detail and send it here.
